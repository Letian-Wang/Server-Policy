...
#### 2. Remote control of the server:
            ...
            4. If you're first time using ssh, it's recommended to refer to the [Detailed tutorial on ssh](Detailed tutorial on ssh.md)", so that no further trouble is made to other users.
